...
get_mean_theta <- function(gf_file="cache/sunflower/mt_gene_up5k.txt"){
  ...
  theta <- fread("oldcache/sunflower/theta.txt", data.table=FALSE)
  names(theta)[1] <- "seq"

  up5k <- fread(gf_file, header=TRUE)
...
```{r, eval=FALSE}
### apply the function
up5k <- get_mean_theta(gf_file="oldcache/sunflower/mt_gene_up5k.txt")
down5k <- get_mean_theta(gf_file="oldcache/sunflower/mt_gene_down5k.txt")
gene <- get_mean_theta(gf_file = "oldcache/sunflower/mt_gene.txt")
```
